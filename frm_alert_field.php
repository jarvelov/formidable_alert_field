    ...
    private function get_alert_condition_fields($field, $form_fields) {
        ...
        foreach ($form_fields as $key => $value) {
            ...
            if( is_array($value['value']) ) {
                ...
                $trigger_values .= '<input type="text" name="field_options[alert_trigger_value_custom_value_' . $field['id']  . ']" placeholder="Enter a custom value" value="' . esc_attr($field['alert_trigger_value_custom_value']) . '" id="alert_trigger_value_' . $key . '_custom_value" class="alert_trigger_value_custom_value" />';
            } else {
