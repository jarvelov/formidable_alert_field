...
class Frm_Alert_Field Extends Frm_Alert {
    ...
    */
    private function get_alert_action_fields($field) {
        ...
        //Actions
        $alert_action_fields = '<div class="alert_action_field ' . echo $active = ($selected_key == 'email') ? 'active_value' : 'inactive_value' . '" id="alert_action_email">';
        ...
        $alert_action_fields .= '<div class="alert_action_field ' . echo $active = ($selected_key == 'frm_action') ? 'active_value' : 'inactive_value' . '" id="alert_action_frm_action">';
