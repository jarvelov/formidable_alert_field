...
class Frm_Alert_Field Extends Frm_Alert {
    ...
    */
    private function get_alert_action_fields($field) {
        ...
        $alert_action_fields = '<div class="alert_action_field ' . $active . '" id="alert_action_email_container">';
        ...
        $alert_action_fields .= '<div class="alert_action_field ' . $active . '" id="alert_action_frm_action_container">';
